...
import com.myapp.jetsnack.ui.components.JetsnackScaffold
import com.myapp.jetsnack.ui.components.JetsnackSnackbar
import com.myapp.jetsnack.ui.components.rememberJetsnackScaffoldState
import com.myapp.jetsnack.ui.home.HomeSections
import com.myapp.jetsnack.ui.home.JetsnackBottomBar
import com.myapp.jetsnack.ui.home.addHomeGraph
import com.myapp.jetsnack.ui.home.composableWithCompositionLocal
import com.myapp.jetsnack.ui.navigation.MainDestinations
import com.myapp.jetsnack.ui.navigation.rememberJetsnackNavController
import com.myapp.jetsnack.ui.snackdetail.SnackDetail
            ...
            CompositionLocalProvider(
                ...
                NavHost(
                    ...
                    composableWithCompositionLocal(
                        ...
                        arguments = listOf(
                            navArgument(MainDestinations.SNACK_ID_KEY) { type = NavType.LongType },
                        ),
                    ) { backStackEntry ->
